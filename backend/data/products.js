const products = [
  {
    ...
    description:
      'One piece Luffy Gear 5th Anime Figure',
    brand: 'OnePiece',
    category: 'Figure',
    price: 89.99,
    countInStock: 10,
